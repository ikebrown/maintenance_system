...
<!--                    <th>Action</th>-->
                ...
                <tr>
                    ...
                    <td><?php echo CHtml::link($row->job_no, array('/superadmin/jobrequest/viewrequest', 'job_id'=>$row->job_id));?></td>
...
<!--                    <td>
                        ...
                        <div class="btn-group text-left">
                          <?php echo CHtml::link('Issue Work Order', array('/superadmin/workorder/createworkorder','job_id'=>$row->job_id), array('class'=>'btn btn-primary'))?>
...
<!--            <td>
                 Split button 
                <div class="btn-group text-left">
                  <?php echo CHtml::link('View Request', array('/superadmin/dailytrip/viewrequest','trip_id'=>$row->trip_id), array('class'=>'btn btn-primary'))?>
                  <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                    <span class="caret"></span>
                    <span class="sr-only">Toggle Dropdown</span>
                  </button>
