...
class MaterialtypeController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('MaterialType');
	...
	{
		$model=MaterialType::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param MaterialType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='material-type-form')
		{
